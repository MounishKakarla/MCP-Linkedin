...
export default function ApiKeySetup({ onSave }: Props) {
  ...
  return (
    <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 flex flex-col gap-5 min-h-[520px] justify-center">
      <div className="flex flex-col items-center gap-3 text-center">
        ...
        <div>
          <h2 className="text-white font-semibold text-lg">Connect your Claude</h2>
      ...
      <div className="flex flex-col gap-3">
        <div className="relative">
          <input
            ...
            className="w-full bg-white/10 border border-white/30 text-white placeholder-white/30 rounded-xl px-4 py-3 pr-20 text-sm font-mono focus:outline-none focus:border-white/60 focus:bg-white/15 transition-all"
          />
          <button
            onClick={() => setShow(s => !s)}
